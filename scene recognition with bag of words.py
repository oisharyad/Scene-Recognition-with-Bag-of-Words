...
def build_vocabulary(image_paths, vocab_size):
  ...
  # visual word vocabulary.
    ...
    #asigning the vocalbulary variable as vocab and descriptors variable
   ...
   ############################################################################
    ...
    for each_image in image_paths:
        img = load_image_gray(each_image)
    ...
    print("It takes ", (end-start), " to compute vocab")
...
def nearest_neighbor_classify(train_image_feats, train_labels, test_image_feats,
  ...
  #############################################################################
    test_labels = []
    #taking list of all calsses in training se
